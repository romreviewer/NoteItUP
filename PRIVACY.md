...
**TL;DR:** Your diary is private. We don't collect, read, or share your personal diary entries. Everything stays on your device unless you choose to use cloud backup.
...
1. **Dropbox** (Optional - only if you enable cloud sync)
...
- You can always find the latest policy at: https://github.com/romreviewer/NoteItUP/blob/main/PRIVACY.md
...
**Email**: romreviewertools@protonmail.com
**GitHub**: https://github.com/romreviewer/NoteItUP/issues
